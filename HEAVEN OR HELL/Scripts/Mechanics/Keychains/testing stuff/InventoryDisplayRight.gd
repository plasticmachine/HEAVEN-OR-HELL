...
func update_all_slots():
		if heaveninventory.keychain_slot_1 != null:
			...
			slot_1_stack.text = str(heaveninventory.keychain_slot_1_stack)
		else:
				slot_1.texture = null
				slot_1_stack.text = ""
		if heaveninventory.keychain_slot_2 != null:
			slot_2.texture = heaveninventory.keychain_slot_2.keychain_texture
			slot_2_stack.text =  str(heaveninventory.keychain_slot_2_stack)
		else:
				slot_2.texture = null
				slot_2_stack.text = ""
		if heaveninventory.keychain_slot_3 != null:
			slot_3.texture = heaveninventory.keychain_slot_3.keychain_texture
			slot_3_stack.text =  str(heaveninventory.keychain_slot_3_stack)
		else:
				slot_3.texture = null
				slot_3_stack.text = ""
		if heaveninventory.keychain_slot_4 != null:
			slot_4.texture = heaveninventory.keychain_slot_4.keychain_texture
			slot_4_stack.text =  str(heaveninventory.keychain_slot_4_stack)
		else:
				slot_4.texture = null
				slot_4_stack.text = ""
		if heaveninventory.keychain_slot_5 != null:
			slot_5.texture = heaveninventory.keychain_slot_5.keychain_texture
			slot_5_stack.text =  str(heaveninventory.keychain_slot_5_stack)
		else:
				slot_5.texture = null
				slot_5_stack.text = ""
