...
func debug_controls():
	if Input.is_action_just_pressed("DEBUG_hell_all_stats_up_(+10)"):
		hellstats.add_all(10)
	if Input.is_action_just_pressed("DEBUG_hell_all_stats_down_(-10)"):
		hellstats.subtract_all(10)
